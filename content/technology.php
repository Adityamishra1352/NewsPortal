...
<body>
    ...
    <section class="main-container">
        ...
        <div class="top-container">
            ...
            $sql = "SELECT * FROM `approvednews` WHERE `newstype`='technology' ORDER BY `timestamp` ";
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<div class="container"><h2><a href="">technology</a></h2>
                    <a href=""><div class="img-wrapper">
                        <img src="https://source.unsplash.com/800x600/?' . $newsTitle . ',technology" alt="">
                    </div></a>
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    <div class="bot-card-left">
                        <div class="bot-img-wrapper">
                            <a href=""><img src="https://source.unsplash.com/300x300/?' . $newsTitle . ',technology" alt=""></a>
                        </div>
                    </div>
                    <div class="bot-card-right">
                        <div class="bot-card-top">
                            <div class="bot-top-type">
                                <a class="bot-tp">News</a><span class="bot-sec-span"><a href="">technology</a></span>
                            </div>
