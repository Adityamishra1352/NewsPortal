...
<body>
    ...
    <section class="main-container">
        ...
        <div class="top-container">
            ...
            $sql = "SELECT * FROM `approvednews` WHERE `newstype`='world' ORDER BY `timestamp` ";
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $newsPicture = $row['newsphoto'];
                        if ($newsPicture != NULL) {
                            ...
                            $pic = "https://source.unsplash.com/800x600/?' . $newsTitle . ',world";
                        }
                    echo '<div class="container"><h2><a href="">world</a></h2>
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($newsPicture != NULL) {
                            ...
                            $pic = "https://source.unsplash.com/300x300/?' . $newsTitle . ',world";
                        }
                    ...
                    <div class="bot-card-right">
                        <div class="bot-card-top">
                            <div class="bot-top-type">
                                <a class="bot-tp">News</a><span class="bot-sec-span"><a href="">world</a></span>
                            </div>
