...
<body>
    ...
    <section class="main-container">
        ...
        <div class="top-container">
            ...
            $sql = "SELECT * FROM `approvednews` WHERE `newstype`='business' ORDER BY `timestamp` ";
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<div class="container"><h2><a href="">Business</a></h2>
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($newsPicture != NULL) {
                            ...
                            $pic = "https://source.unsplash.com/300x300/?' . $newsTitle . ',business";
                        }
                    ...
                    <div class="bot-card-right">
                        <div class="bot-card-top">
                            <div class="bot-top-type">
                                <a class="bot-tp">News</a><span class="bot-sec-span"><a href="">Business</a></span>
                            </div>
