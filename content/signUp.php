...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($cpassword == $password) {
        ...
        $insert_sql = "INSERT INTO `users`(`username`,`firstname`,`lastname`,`password`,`email`)VALUES('$username','$firstname','$lastname','$hash','$email')";
        $result = mysqli_query($conn, $insert_sql);
        if($result){
            $signup="Successfully Signed Up!!";
        }
        else{
            $signup="Couldnot not sign up";
        }
    }
    else{
        $signup="Passwords donot match";
    }
}
}
?>
...
<body>
    ...
    <div class="signup-container">
        ...
        <form method="post" action="signUp.php">
            ...
            <button id="submitDetails">Create my account</button>
        </form>
    </div>
    <footer>
